 ...
 * 스타일: static/css/common.css (.app-btn)
 *
 * ============================================================
 * 사용법
 * ============================================================
 ...
 *
 * 옵션:
 *   icon   - 아이콘 이름 (print, plus, edit, delete, copy, download, search, refresh)
 *   style  - 버튼 스타일 (primary, outline, danger, success, teal)   기본: outline
...
var AppButton = (function() {
    ...
    function buildHtml(label, fnName, opts) {
        ...
        return '<button class="' + cls + '"' + onclick + '>' +
               (iconHtml ? iconHtml + ' ' : '') + label + '</button>';
    }
