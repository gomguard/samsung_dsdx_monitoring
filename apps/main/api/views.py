...
@login_required
def ds_document_file(request, file_name):
...
@login_required
@require_POST
def ds_document_create(request):
    """DS 문서 생성 API"""
    from apps.common.db import get_ds_connection
...
@login_required
@require_POST
def ds_document_update(request, document_id):
    """DS 문서 수정 API"""
    from apps.common.db import get_ds_connection
    from apps.common.ds.files import ds_cleanup_orphan_files
    from apps.common.response import safe_error
...
# ============================================================
# DS Document Share API
# ============================================================

@login_required
@require_POST
def ds_document_share_token(request):
