...
urlpatterns = [
    ...
    path('api/fileserver-browse/', api_views.fileserver_browse, name='api_fileserver_browse'),
    path('api/fileserver-move/', api_views.fileserver_move, name='api_fileserver_move'),
